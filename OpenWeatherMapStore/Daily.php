...
/**
 * Generated from protobuf message <code>openweathermap_store.Daily</code>
 */
class Daily extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.openweathermap_store.Temp Temp = 7 [json_name = "temp"];</code>
     */
    protected $Temp = null;
    /**
     * Generated from protobuf field <code>.openweathermap_store.FeelsLike FeelsLike = 8 [json_name = "feels_like"];</code>
     */
     ...
     *     @type \Openweathermap_store\Temp $Temp
     *     @type \Openweathermap_store\FeelsLike $FeelsLike
     *     @type int $Pressure
     *     @type int $Humidity
     *     @type float $DewPoint
    ...
    /**
     * Generated from protobuf field <code>.openweathermap_store.Temp Temp = 7 [json_name = "temp"];</code>
     * @return \Openweathermap_store\Temp|null
     */
    ...
    /**
     * Generated from protobuf field <code>.openweathermap_store.Temp Temp = 7 [json_name = "temp"];</code>
     * @param \Openweathermap_store\Temp $var
     * @return $this
     */
    public function setTemp($var)
    {
        GPBUtil::checkMessage($var, \Openweathermap_store\Temp::class);
        $this->Temp = $var;
    ...
    /**
     * Generated from protobuf field <code>.openweathermap_store.FeelsLike FeelsLike = 8 [json_name = "feels_like"];</code>
     * @return \Openweathermap_store\FeelsLike|null
     */
    ...
    /**
     * Generated from protobuf field <code>.openweathermap_store.FeelsLike FeelsLike = 8 [json_name = "feels_like"];</code>
     * @param \Openweathermap_store\FeelsLike $var
     * @return $this
     */
    public function setFeelsLike($var)
    {
        GPBUtil::checkMessage($var, \Openweathermap_store\FeelsLike::class);
        $this->FeelsLike = $var;
